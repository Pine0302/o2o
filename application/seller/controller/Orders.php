...
class Orders extends Base {
    ...
    public function ajaxindex(){
        ...
        $condition = array('store_id'=>$this->store_id,'type'=>2);
        ...
        $order_num =  ($keyType && $keyType == 'order_num') ? $keywords : I('order_num','','trim');
        $order_num ? $condition['order_num'] = trim($order_num) : false;
