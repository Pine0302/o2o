...
class Ordero extends Base {
    ...
    public function _initialize() {
        ...
        $this->order_status = C('ORDER_STATUS_1');
    ...
    public function ajaxindex(){
        ...
        $condition = array('store_id'=>$this->store_id,'type'=>1);
   ...
   /*     if(I('pay_code')){
        ...
        foreach($orderList as $ko=>$vo){
            $user_info = Db::name('users')->where('user_id','=',$vo['user_id'])->find();
            $orderList[$ko]['weixin_mobile'] = $user_info['weixin_mobile'];
        }
