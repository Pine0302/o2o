...
class Comment extends Base {
    ...
    public function ajaxindex(){
        ...
        foreach($comment_list as $kc=>$vc){
            $order_info = Db::name('order')->where('order_id','=',$vc['order_id'])->find();
         //   var_dump($order_info);exit;
            $comment_list[$kc]['order_info'] = $order_info;
            if(!$order_info['consignee']){
                $user_info = Db::name('users')->where('user_id','=',$vc['user_id'])->find();
                $comment_list[$kc]['order_info']['consignee'] = $user_info['nickname'];
            }
        }
